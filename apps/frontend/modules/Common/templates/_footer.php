    ...
    <div class="container" id="footers" style="padding-left: 20px;">
        ...
        <div class="box_infor" style="padding-top: 36px;">
            <p class="address" style="width: 400px;">
                ...
                <span>Cơ quan chủ quản: Viettel Telecom - Chăm sóc<br>khách hàng 18008098 (Miễn phí)</span>
            </p>
            <p class="phone">
                <i class="fa fa-book" aria-hidden="true"></i>
                <span>Điều khoản sử dụng | Hướng dẫn sử dụng</span>
            </p>
        </div>
    </div>
</footer>
<div class="fixnav">
    <div class="fixbtns view_tab-sp">
